...
CREATE TABLE IF NOT EXISTS `mydb`.`Tickets` (
  ...
  INDEX `fk_Tickets_Utilisateurs_idx` (`Utilisateurs_idUtilisateurs` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Utilisateurs_has_Groupes` (
  ...
  INDEX `fk_Utilisateurs_has_Groupes_Groupes1_idx` (`Groupes_idGroupes` ASC) VISIBLE,
  INDEX `fk_Utilisateurs_has_Groupes_Utilisateurs1_idx` (`Utilisateurs_idUtilisateurs` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Réseaux` (
  ...
  INDEX `fk_Réseaux_Tickets1_idx` (`Tickets_idTickets` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Téléphones` (
  ...
  INDEX `fk_Téléphones_Tickets1_idx` (`Tickets_idTickets` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Lieux` (
  ...
  INDEX `fk_Lieux_Utilisateurs1_idx` (`Utilisateurs_idUtilisateurs` ASC) VISIBLE,
  INDEX `fk_Lieux_Réseaux1_idx` (`Réseaux_idRéseaux` ASC) VISIBLE,
  INDEX `fk_Lieux_Téléphones1_idx` (`Téléphones_idTéléphones` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Ordinateurs` (
  ...
  INDEX `fk_Ordinateurs_Tickets1_idx` (`Tickets_idTickets` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Imprimantes` (
  ...
  INDEX `fk_Imprimantes_Tickets1_idx` (`Tickets_idTickets` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Ordinateurs_has_Utilisateurs` (
  ...
  INDEX `fk_Ordinateurs_has_Utilisateurs_Utilisateurs1_idx` (`Utilisateurs_idUtilisateurs` ASC) VISIBLE,
  INDEX `fk_Ordinateurs_has_Utilisateurs_Ordinateurs1_idx` (`Ordinateurs_idOrdinateurs` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Téléphones_has_Utilisateurs` (
  ...
  INDEX `fk_Téléphones_has_Utilisateurs_Utilisateurs1_idx` (`Utilisateurs_idUtilisateurs` ASC) VISIBLE,
  INDEX `fk_Téléphones_has_Utilisateurs_Téléphones1_idx` (`Téléphones_idTéléphones` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Logiciels` (
  ...
  INDEX `fk_Logiciels_Tickets1_idx` (`Tickets_idTickets` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Logiciels_has_Ordinateurs` (
  ...
  INDEX `fk_Logiciels_has_Ordinateurs_Ordinateurs1_idx` (`Ordinateurs_idOrdinateurs` ASC) VISIBLE,
  INDEX `fk_Logiciels_has_Ordinateurs_Logiciels1_idx` (`Logiciels_idLogiciels` ASC) VISIBLE,
